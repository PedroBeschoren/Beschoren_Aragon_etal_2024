...
# save both pltos as a pannel
p.lox2.Atha.Bole<-ggarrange(p.lox2.Atha, p.lox2.Bole, common.legend = TRUE, labels = "AUTO")

ggsave(p.lox2.Atha.Bole,
       height = 90, width = 180, units = "mm",
       file="./R output/Figures_for_publication/traits_BOAT_pannel_LOX2.svg")
