...
full_feature_rf_repeatedcv <- lapply(list_boruta_input, function(x) {
  ...
  model_full_feature <- train(MeJA_treatment ~ .,
...
plot_rf <- grid.arrange(plot_rf_asvs$Arabidopsis_thaliana.Root, plot_rf_asvs$Arabidopsis_thaliana.Soil, plot_rf_asvs$Brassica_oleraceae.Root, plot_rf_asvs$Brassica_oleraceae.Soil, nrow = 2, ncol = 2)
