...
diversity_df$Simpson_above_expected<- simpson_df
...
ggplot(data=z[z$Simpson_above_expected >0,], #only includes shannon >0
  ...
  geom_smooth(method="loess")+ #values of y are based on the values of x
  labs(subtitle = paste("Spearman rank correlation:",
                        stats::cor(z$Simpson_full_dataset,
                                  z$Simpson_above_expected ,
                                  method = "spearman" ),
                        sep = " "))+
  geom_text_repel(aes(label=z[z$Simpson_above_expected >0,1]), data = z[z$Simpson_above_expected >0,]))
