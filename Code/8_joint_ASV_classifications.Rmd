...
scoring_variables<-c("important_in_rf", #random forest def
                      ...
                      "is_above_expected", "above_in_2_treatments_absent_control", "above_only_in_control") # neutral  def
...
simplified_ASV_importance_scores<-lapply (ASV_importance_scores, function (x)
         ...
         select(important_in_rf, is_above_expected, has_network_tag,is_differentially_abundant )) # select a part of the df
