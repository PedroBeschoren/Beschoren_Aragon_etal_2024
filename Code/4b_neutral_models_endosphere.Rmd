...
neutral_list_BO_Root, plot_titles,
SIMPLIFY = FALSE
)
...
Neutral_plots_list_BO_Root_g <- ggarrange(Neutral_plots_list_BO_Root$control,
  ...
  Neutral_plots_list_BO_Root$oral_secretion, 
  ncol = 2, nrow = 2
)
...
neutral_list_AT_Root, plot_titles,
SIMPLIFY = FALSE
)
########################
...
Neutral_plots_list_AT_Root_g <- ggarrange(Neutral_plots_list_AT_Root$control,
  ...
  Neutral_plots_list_AT_Root$oral_secretion, 
  ncol = 2, nrow = 2
)
...
heat_tree_matrix(neutral_metacoder_BO,
  ...
  output_file = "./R output/differential_heat_tree_BO_root.pdf"
...
heat_tree_matrix(test,
  ...
  output_file = "./R output/differential_heat_tree_AT_root.pdf"
) # Saves the plot as a pdf file
```
