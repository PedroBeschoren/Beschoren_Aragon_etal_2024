...
Decontamination with the decontam package only removed a single OTU from analysis. This is because we did not have enough blank DNA extraction samples. you should use at least 3 blank samples for minimal decontamination. we continue to use this filtering regardless of it's low performance.
...
physeq_filtered_rarefied = rarefy_even_depth(physeq = physeq_filtered, 
