...
venn_neutral(ps_l_predictions_in_taxtable = ps_list_neutral_BO_soil)+
...
#run the custom function
venn_neutral(ps_l_predictions_in_taxtable = ps_list_neutral_AT_soil)+
...
ggsave(histogram_100_permanovas,
       height = 5, width = 15,
       file="./R output/Figures_for_publication/histogram_100_permanovas.svg")
