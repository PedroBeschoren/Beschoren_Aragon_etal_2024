...
cohensD_per_trait <- function(df, variable){
  
  #variable <- noquote(trait)
  print(df$variable)
  
}  
  

try <- cohensD_per_trait(Bole, variable)
...
Ctrl<- Bole %>% 
       dplyr::filter(treatment == "control") %>% .$trait
