...
p.cohensD <- ggplot(data = d_traits, mapping = aes(x = trait, y = estimate,
  ...
  scale_x_discrete(name="plant traits measured") +
  scale_y_continuous(name="Cohen's D", limits = c(-10,5)) +
  coord_flip() +
  theme_minimal()
